...
exports.signUp = async (req, res, next) => {
  ...
  try {
    ...
    return res.status(200).send({ message: "Admin created successfully!", user: savedAdmin  });
  } catch (error) {
...
exports.logIn = async (req, res) => {
  ...
  try {
    ...
    const token = await jwt.sign({ _id: foundAdmin._id }, "12345");
...
exports.updateAdmin = async (req, res) => {
  try {
    ...
    return res.status(200).send({ message: "Admin updated successfully", updatedUser});
...
exports.deleteAdmin = async (req, res) => {
  try {
    ...
    return res.status(200).send({ message: "Admin deleted successfully", user: deletedAdmin});
  } catch (error) {
